...
@section('includes')
    ...
    @include( 'admin.proceso.js.validarfirma_ajax' )
    @include( 'admin.proceso.js.validarfirma' )
@stop
                    ...
                    <div class="col-sm-12">
                        ...
                        <table id="t_fichas_recepcionadas" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td colspan='5' style='text-align:center; background-color:#DEACA9;'>
                                    <h2>
                                        Fichas Validadas
                                    </h2>
                                </td>
                            ...
                            <tr>
                                ...
                                <th style='background-color: #F2DCDB'>Fichas<br>Buenas</th>
                                <th style='background-color: #F2DCDB'>Fichas<br>Malas</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                            <tfoot>
