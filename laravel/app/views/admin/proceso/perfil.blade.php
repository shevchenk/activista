        ...
        {{--</div>--}}
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" ng-if="idNivel < 4"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab" ng-click="showGuardar = true">Centro de votacion</a></li>
                ...
                <div class="tab-content" >
                    ...
                    <div ng-if="idNivel < 4" role="tabpanel" class="tab-pane" id="settings"><p></p>
                        <fieldset>
                            <legend>
                                Centro de votación
                            </legend>
