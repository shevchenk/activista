...
@section('includes')
    ...
    @include( 'admin.reporte.js.fanpage_ajax' )
    @include( 'admin.reporte.js.fanpage' )
@stop
                ...
                <fieldset>
                    <div class="row form-group" >
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <label class="control-label">Consolidado:</label>
                                <select class="form-control" name="slct_consolidado" id="slct_consolidado">
